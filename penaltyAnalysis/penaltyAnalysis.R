...
school_colors <- read.xlsx("../school_colors/school_colors.xlsx")
data <- read.csv("../../data/FBS/experiment/SEC_stats_2021.csv")

SECteams <- scan("../../data/FBS/SEC_teams.csv", sep = ",", what = "")
# Bama vs opp ------------------------------------------------------------------
